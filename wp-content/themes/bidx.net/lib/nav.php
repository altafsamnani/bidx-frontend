 ...
 *
 * Bidx_Nav_Walker example output:
 *   <li class="menu-home"><a href="/">Home</a></li>
 *   <li class="menu-sample-page"><a href="/sample-page/">Sample Page</a></li>
 */
class Bidx_Nav_Walker extends Walker_Nav_Menu
{
...
add_filter ('nav_menu_css_class', 'bidx_nav_menu_css_class', 10, 2);
 ...
 * Use Bidx_Nav_Walker() by default
 */
function bidx_nav_menu_args ($args = '')
{
    $bidx_nav_menu_args['container'] = false;

    if (!$args['items_wrap']) {
        $bidx_nav_menu_args['items_wrap'] = '<ul class="%2$s">%3$s</ul>';
    }

    if (current_theme_supports ('bootstrap-top-navbar')) {
        $bidx_nav_menu_args['depth'] = 3;
    }
...
add_filter ('wp_nav_menu_args', 'bidx_nav_menu_args');
