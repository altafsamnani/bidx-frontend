<footer>
				...
				<div class="row-fluid footer-links">
					<div class="span3">
						...
						<ul>
							...
							<li><a href="#">BUSINESS PLAN TOOL</a></li>
							<li><a href="#">FINANCE READY PLANS</a></li>
						</ul>
					</div><!--/span-->
					<div class="span3">
						<h3>Support</h3>
						<ul>
							...
							<li><a href="#">EMAIL bidX SUPPORT</a></li>
							<li><a href="#">TUTORIALS</a></li>
							<li><a href="#">FORUMS</a></li>
							<li><a href="#">bidX TEMPLATES</a></li>
		...
		<div class="block-odd">
			...
			<br/>
			<br/>
			<?php wp_nav_menu(array('theme_location' => 'footer_navigation', 'menu_class' => 'nav menu')); ?>
			<br/>
			<br/>
			<br/>
			<br/>
