<?php
/**
 * Bidx adjusted version of Sunrise
 * 
 */
...
if( $domain_mapping_id ) {
	...
	//Added for transport of original multi domain so the plugins can use this
	define ( 'ORIGINAL_DOMAIN', $current_blog->domain );
