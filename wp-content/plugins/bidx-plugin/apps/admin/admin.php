...
class AdminPage {
	...
	function register_monitoring_page() {
		...
		add_submenu_page( 'Users', 							//parent slug
		'Monitoring', 			   							//page title
		'Monitoring',			   							//menu title
		'editor',				   							//capability
		'monitoring-page',									//menu-slug
	...
	function monitoring_page_callback() {
		...
		echo '<h2>'.__( 'Monitoring', 'bidx_competition' ).'</h2>';
			
			?>
				<script>var monitordata='' ;</script>
	 ...
	 * 
	 */
	class UserMonitorMetabox 
		extends StatisticsMetabox {
